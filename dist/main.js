...
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @angular/common/http */ 841);
...
/* harmony import */ var _core_plain_logger_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./core/plain-logger.service */ 7742);
/* harmony import */ var _core_book_tracker_error_handler_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./core/book-tracker-error-handler.service */ 772);
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_12__.NgModule)({
        ...
        providers: [
            ...
            _core_plain_logger_service__WEBPACK_IMPORTED_MODULE_9__.PlainLoggerService,
...
BookTrackerErrorHandlerService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
...
let DataService = class DataService {
    ...
    handleError(error) {
        let dataEror = new app_models_bookTrackerError__WEBPACK_IMPORTED_MODULE_1__.BookTrackererror();
        dataEror.errorMumber = 100;
        dataEror.message = error.statusText;
        dataEror.friendlyMessage = 'An error occured retrieving data.';
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.throwError)(dataEror);
    }
    getReaderById(id) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PlainLoggerService": () => (/* binding */ PlainLoggerService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ 4762);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ 7716);


let PlainLoggerService = class PlainLoggerService {
    constructor() { }
    log(message) {
...
PlainLoggerService.ctorParameters = () => [];
PlainLoggerService = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.Injectable)()
], PlainLoggerService);
